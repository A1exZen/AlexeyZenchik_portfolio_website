...
const About = () => {
	return (
		<section id='about' className='section-wrapper'>
			...
			<div className='grid md:grid-cols-[1fr_500px] gap-[4.5rem]'>
				<div>
					<motion.div
					...
					>
						<p className='mb-[2.5rem] font-[200]'>
							I possess excellent communication skills and the ability to work
							...
							<br />
							<br />I have experience working with the following technology
							stack based on React JS, and more...
						</p>
					</motion.div>
